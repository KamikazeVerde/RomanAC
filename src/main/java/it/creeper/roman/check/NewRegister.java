...
import it.creeper.roman.check.impl.combat.aura.IrregularCombat;
import it.creeper.roman.check.impl.movement.FakeGround;
import it.creeper.roman.check.impl.movement.MovementX;
...
public class NewRegister {
    ...
    public MovementX movementX = new MovementX();
    public void registerModulesNew() {
        ...
        modules.add(new IrregularCombat());
        modules.add(movementX);
        //modules.add(new IrregularCombat());
